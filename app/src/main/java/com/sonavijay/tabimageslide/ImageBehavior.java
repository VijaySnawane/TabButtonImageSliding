...
public class ImageBehavior extends CoordinatorLayout.Behavior<SlideView> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, SlideView child, View dependency) {
        return dependency instanceof AppBarLayout;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, SlideView child, View dependency) {
    ...
    private void shouldInitProperties(SlideView child, View dependency) {
